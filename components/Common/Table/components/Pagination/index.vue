<template>
  ...
  <div
    class="bg-white px-4 py-3 flex flex-col md:flex-row flex-col-reverse items-center justify-between border-t border-gray-200 sm:px-6"
  >
    <div
...
export default {
  ...
  computed: {
    ...
    currentPageMin() {
      return this.page === 1 ? 1 : this.page * this.limit + 1 - this.limit
    },
    currentPageMax() {
      return this.page < Math.ceil(this.pages * 0.9)
